  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-patapam-green">
      <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-sm">
        <h1 className="text-3xl font-bold text-patapam-green text-center mb-2">
          Le Monde de Patapam
        </h1>
        <p className="text-center text-gray-500 mb-6 text-sm">Espace parents</p>
        ...
        <button
          ...
          className="touch-target w-full flex items-center justify-center gap-3 border border-gray-300 rounded-xl px-6 py-3 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors mb-4"
        >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {info  && <p className="text-patapam-green text-sm text-center">{info}</p>}

          <button
            type="submit"
            disabled={loading}
            className="touch-target bg-patapam-green text-white font-bold rounded-xl px-6 py-3 mt-2 hover:opacity-90 disabled:opacity-50 transition-opacity"
          >
            {loading
              ? '…'
